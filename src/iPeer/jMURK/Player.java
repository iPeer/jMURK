...
public class Player {
	public Player(String n) {
		String inventory = "Soul Sword|1,Test Aid|9999,Test Weapon|1,Baul|5,Wooden Sword|1,Leather Slacks|1,Leather Tunic|1,Leather Cap|1,Gold Pendant|1";
		Random r = new Random();
		...
		p.put("Weapon", /*"Wooden Sword"*/"Soul Sword");
